...
namespace Tibialyzer {
    ...
    public static class Extensions {
        public static int Distance(this System.Drawing.Rectangle rect, System.Drawing.Point point) {
            int horizontalDistance = rect.X > point.X ? rect.X - point.X : (point.X > rect.X + rect.Width ? point.X - (rect.X + rect.Width) : 0);
            int verticalDistance = rect.Y > point.Y ? rect.Y - point.Y : (point.Y > rect.Y + rect.Height ? point.Y - (rect.Y + rect.Height) : 0);
