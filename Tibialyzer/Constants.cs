...
namespace Tibialyzer {
    class Constants {
        ...
        public static HashSet<string> worlds = new HashSet<string>() { "amera", "antica", "astera", "aurera", "aurora", "bellona", "beneva", "calmera", "calva", "calvera", "candia", "celesta", "chrona", "danera", "dolera", "efidia", "eldera", "fidera", "fortera", "garnera", "guardia", "harmonia", "honera", "hydera", "inferna", "iona", "irmada", "julera", "justera", "kenora", "kronera", "laudera", "luminera", "magera", "menera", "morta", "mortera", "neptera", "nerana", "nika", "olympa", "osera", "pacera", "premia", "pythera", "quilia", "refugia", "rowana", "secura", "shivera", "silvera", "solera", "thera", "umera", "unitera", "veludera", "xantera", "xylana", "yanara", "zanera", "zeluna" };
