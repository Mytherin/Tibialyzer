...
namespace Tibialyzer {
    class Constants {
        ...
        public static List<string> NotificationTestCommands = new List<string> { "loot@", "damage@", "creature@quara", "city@venore", "creature@demon", "stats@dragon lord", "hunt@formorgar mines", "item@heroic axe", "npc@rashid", "outfit@brotherhood", "quest@killing in the name of", "spell@light healing", "guide@desert dungeon quest", "task@crystal spider", "experience@", "waste@", "summary@", "route@1500,500,7", "map@", "healing@", "damagetaken@", "achievement@peazzekeeper" };
        public static List<string> NotificationTypeObjects = new List<string>() { "LootDropForm", "DamageChart", "CreatureList", "CityDisplayForm", "CreatureDropsForm", "CreatureStatsForm", "HuntingPlaceForm", "ItemViewForm", "NPCForm", "OutfitForm", "QuestForm", "SpellForm", "QuestGuideForm", "TaskForm", "ExperienceChart", "WasteForm", "SummaryForm", "RouteForm", "MapForm", "HealingChart", "DamageTakenChart", "AchievementForm" };
