...
namespace Tibialyzer {
    class Constants {
        ...
        public static List<string> HudTypes = new List<string> { "Health Bar", "Mana Bar", "Experience Bar", "Curved Bars" };
        public static List<string> HudTestCommands = new List<string> { "hud@healthbar", "hud@manabar", "hud@experiencebar", "hud@curvedbars" };
